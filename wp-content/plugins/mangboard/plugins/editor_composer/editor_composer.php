		...
		$template_start	= '<div class="mb-editor-composer mb-editor-composer-'.$editor_id.'" style="display:none;'.$style.'">';
			...
			$template_start	.= '<div class="mb-layout-btn-box">';				
				...
				$template_start	.= '<div class="mb-layout-option-box">';
					...
					$template_start	.= '<div onclick="checkCSSDisplay(\'.mb-editor-video-'.$editor_id.'\');return false;" class="mbc_editor_video cursor_pointer" title="'.__MW("W_VIDEO_INSERT").'"><img src="'.MBW_PLUGIN_URL.'plugins/editor_composer/img/icon_editor_video.png" style="width:13px;margin: 3px 0 3px !important;vertical-align: top !important;"> '.__MW("W_VIDEO").'</div>';
